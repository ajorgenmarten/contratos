import { ClientCategory, ClientDenomination, ContractContainer, ContractType, } from "@/types/interfaces";
...
const contractSchema = z.object({
    ...
    clientDenomination: z.enum(ClientDenomination, "Por favor seleccione una denominación de cliente"),
    clientCategory: z.enum(ClientCategory, "Por favor seleccione una categoría de cliente"),
...
export default function useAddContract() {
    const [contractContainer, setContractContainer] = useState();
    const [contractDetails, setContractDetails] = useState([]);
    const [contractTypes, setContractTypes] = useState();
    const { formState, watch, setValue, register, getValues, control, reset, handleSubmit, } = useForm({
